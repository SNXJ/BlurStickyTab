...
public class GaussPager extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mTop = (ViewGroup) findViewById(R.id.id_sticky_layout_topview);
        ...
        bgLayer = (RelativeLayout) findViewById(R.id.id_sticky_layout_topview);
...
//        new BlurTask().execute();
        ...
        blurImageView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,bgLayer.getHeight()));
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(dy) > mTouchSlop) {
                    ...
                    if (mInnerScrollView instanceof ScrollView) {
                        ...
                        View c=null;
                        //不同布局做不同判断处理
                        if (llm instanceof StaggeredGridLayoutManager) {//瀑布流
                        ...
                        } else if(llm instanceof LinearLayoutManager){
    ...
    private void getCurrentScrollView() {
        ...
        if (a instanceof FragmentPagerAdapter) {
            ...
            mInnerScrollView = (ViewGroup) (item.getView()
                    .findViewById(R.id.id_sticky_layout_inner_scrollview));
